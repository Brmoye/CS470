...
from easyAI import id_solve  # type: ignore
from easyAI import AI_Player, Human_Player, TwoPlayersGame  # type: ignore
from easyAI.AI import TT  # type: ignore
...
if __name__ == "__main__":
    ...
    # Define the method
    LastCoinStanding.ttentry = lambda self: self.num_coins  # type: ignore

    # Solve the game
    result, depth, move = id_solve(LastCoinStanding, 
            range(2, 4), win_score=100, tt=tt)
